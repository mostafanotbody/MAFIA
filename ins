...
${CNIL}";
echo -e "${RED}| Sorry Canot install Source on Ubuntu {${Version}} Please install system To Ubuntu ${SMAY}14 or 16 ${RED} For Run The Source revor 
${CNIL}";
exit;
fi
...
¦ NOW you can not install the SOURCE DANY. \n
...
GET_INSTALL=$(redis-cli get DANY_INSTALL)
fi
if [ "${GET_INSTALL}" == "Yes" ]; then
echo -e "
${SMAY}>> ${LSAMAY}Source DANY${SMAY} is Already Installed ^_^ .\n${CNIL}"
...
chmod +x ./run
echo -e "\n
${SMAY}>> Installation ${LSAMAY}Source DANY${SMAY} Completed ^_^ .\n
Now I Have Information For Your Bot  \n
1- Enter Token Your Bot .
2- Enter Your UserName Sudo .
3- And End Press Enter To Run Source DANY .\n\n
